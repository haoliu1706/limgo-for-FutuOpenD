...
func (ReferenceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Qot_GetReference_2cf74921884a851e, []int{0}
}
...
func (*S2C) Descriptor() ([]byte, []int) {
	return fileDescriptor_Qot_GetReference_2cf74921884a851e, []int{1}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_Qot_GetReference_2cf74921884a851e, []int{2}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_Qot_GetReference_2cf74921884a851e, []int{3}
}
...
func init() {
	proto.RegisterFile("Qot_GetReference/Qot_GetReference.proto", fileDescriptor_Qot_GetReference_2cf74921884a851e)
}

var fileDescriptor_Qot_GetReference_2cf74921884a851e = []byte{
